...
class ChooseRoleController: ChooseEntityController<ChooseRoleTarget> {
}

//
//class ChooseRoleController: UITableViewController, NSFetchedResultsControllerDelegate, ChooseItemController {
//    let showIdentifiers = false
//
//    var row: BookPersonRow? = nil
//    var fetcher: NSFetchedResultsController<Role>? = nil
//
//    func setup(detailView: BookDetailController, row: UITableViewCell) {
//        if let personRow = row as? BookPersonRow {
//            self.row = personRow
//            fetcher = makeFetcher()
//        }
//    }
