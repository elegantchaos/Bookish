...
public struct SelectPreviousRecordIndexCommand<Centre: BookishNavigationProvider>: CommandWithUI {
  ...
  public func perform(centre: Centre) async throws {
    try await centre.navigationService.selectPreviousRecordIndex()
  }
}
