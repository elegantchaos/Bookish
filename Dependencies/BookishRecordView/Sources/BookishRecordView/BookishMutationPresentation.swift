...
/// A display-ready representation of a datastore mutation for Bookish views.
public struct BookishMutationPresentation: Equatable, Sendable {
  ...
  private func field(_ id: String, _ label: String, _ value: String) -> BookishRecordField {
    BookishRecordField(key: id, label: label, value: value)
  }
}
