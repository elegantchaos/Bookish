...
public enum BookishRecordKey {
  ...
  /// When an import record's import was applied.
  public static let importDate = "importDate"

  /// Records an import added, linked from its import record.
  public static let importAdded = "importAdded"

  /// Existing records an import replaced, linked from its import record.
  public static let importReplaced = "importReplaced"

  /// Existing records an import kept instead of the imported version, linked from its import record.
  public static let importKept = "importKept"

  /// Existing records an import linked in place of matching imported records, linked from its
  /// import record.
