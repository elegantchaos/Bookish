...
/// Maintains the prototype browser route independently from datastore services.
///
...
@MainActor
@Observable
public final class DatastorePrototypeNavigationService {
...
extension DatastorePrototypeNavigationService: CommandCentre {
}
