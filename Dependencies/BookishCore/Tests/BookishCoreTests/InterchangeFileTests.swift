...
struct InterchangeFileTests {

  @Test

  func writingEmpty() throws {
    let type = InterchangeFileType("test", version: 1)
    let creator = InterchangeCreator(
      id: "some.app", version: "1.0", build: 1, commit: "sha-hash-here")
    ...
    #expect(Self.emptyFileJSON == json)
  }

  @Test

  func writingRecords() throws {
